<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <a class="btn btn-primary pull-right" href="<?php echo route(config('quarx.backend-route-prefix', 'quarx').'.faqs.create'); ?>">Add New</a>
        <div class="raw-m-hide pull-right">
            <?php echo Form::open(['url' => 'quarx/faqs/search']); ?>
    ...
    <div class="row">
        ...
        <?php else: ?>
            <table class="table table-striped">
                <thead>
                    <th><?php echo sortable('Question', 'question'); ?></th>
                ...
                <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><a href="<?php echo route(config('quarx.backend-route-prefix', 'quarx').'.faqs.edit', [$faq->id]); ?>"><?php echo $faq->question; ?></a></td>
                        <td class="raw-m-hide">
                        ...
                        <td class="text-right">
                            <form method="post" action="<?php echo url(config('quarx.backend-route-prefix', 'quarx').'/faqs/'.$faq->id); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <a class="btn btn-xs btn-default pull-right raw-margin-right-8" href="<?php echo route(config('quarx.backend-route-prefix', 'quarx').'.faqs.edit', [$faq->id]); ?>"><i class="fa fa-pencil"></i> Edit</a>
                        </td>
                    </tr>
