<?php if(isset($page)): ?>
    <?php $__env->startSection('seoDescription'); ?> <?php echo e($page->seo_description); ?> <?php $__env->stopSection(); ?>
    <?php $__env->startSection('seoKeywords'); ?> <?php echo e($page->seo_keywords); ?> <?php $__env->stopSection(); ?>
<?php endif; ?>
...
<?php $__env->startSection('quarx'); ?>
    <?php if(isset($page)): ?>
        <?php echo Quarx::editBtn('pages', $page->id); ?>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('quarx-frontend::layout.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>