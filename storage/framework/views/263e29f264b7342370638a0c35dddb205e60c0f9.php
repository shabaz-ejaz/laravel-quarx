<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <a class="btn btn-primary pull-right" href="<?php echo route(config('quarx.backend-route-prefix', 'quarx').'.images.create'); ?>">Add New</a>
        <div class="raw-m-hide raw-m-hide pull-right">
            <?php echo Form::open(['url' => 'quarx/images/search']); ?>
            ...
            <div class="row">
                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 image-panel raw-margin-top-24">
                        <div class="thumbnail">
                            <a href="<?php echo route(config('quarx.backend-route-prefix', 'quarx').'.images.edit', [$image->id]); ?>">
                                <div class="img" style="background-image: url('<?php echo $image->url; ?>')"></div>
                            </a>
                        </div>
                        <div data-id="<?php echo e($image->id); ?>" class="well pull-down overflow-hidden selectable">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <form method="post" action="<?php echo url(config('quarx.backend-route-prefix', 'quarx').'/images/'.$image->id); ?>">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <a class="btn btn-xs btn-default pull-right img-alter-btn raw-margin-right-8" href="<?php echo route(config('quarx.backend-route-prefix', 'quarx').'.images.edit', [$image->id]); ?>"><i class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
