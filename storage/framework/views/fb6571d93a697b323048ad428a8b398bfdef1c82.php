                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo route('posts.edit', [$post->id]); ?>"><?php echo e($post->name); ?></a>
                                </td>
                                <td class="text-right">
                                    <form method="post" action="<?php echo route('posts.destroy', [$post->id]); ?>">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <a class="btn btn-default btn-xs pull-right raw-margin-right-16" href="<?php echo route('posts.edit', [$post->id]); ?>"><i class="fa fa-pencil"></i> Edit</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('quarx::layouts.dashboard', ['pageTitle' => '_camelUpper_casePlural_ &raquo; Index'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>