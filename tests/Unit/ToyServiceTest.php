...
class ToyServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(ToyService::class);
        $this->originalArray = [
            'id' => '1',
		' title' => 'labore',
		'author' => 'sunt',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Toy');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('toys', $this->editedArray);
    }
